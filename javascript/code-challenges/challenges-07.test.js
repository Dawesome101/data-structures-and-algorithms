...
const listFoods = (recipe) => {
  let result = [];
  result.push(gruffaloCrumble.ingredients[0].slice(gruffaloCrumble.ingredients[0].indexOf('Gruffalo')));
  result.push(gruffaloCrumble.ingredients[1].slice(gruffaloCrumble.ingredients[1].indexOf('oats')));
  result.push(gruffaloCrumble.ingredients[2].slice(gruffaloCrumble.ingredients[2].indexOf('brown sugar')));
  result.push(gruffaloCrumble.ingredients[3].slice(gruffaloCrumble.ingredients[3].indexOf('flour')));
  result.push(gruffaloCrumble.ingredients[4].slice(gruffaloCrumble.ingredients[4].indexOf('pure maple syrup')));
  result.push(gruffaloCrumble.ingredients[5].slice(gruffaloCrumble.ingredients[5].indexOf('chopped nuts')));
  result.push(gruffaloCrumble.ingredients[6].slice(gruffaloCrumble.ingredients[6].indexOf('baking soda')));
  result.push(gruffaloCrumble.ingredients[7].slice(gruffaloCrumble.ingredients[7].indexOf('baking powder')));
  result.push(gruffaloCrumble.ingredients[8].slice(gruffaloCrumble.ingredients[8].indexOf('cinnamon')));
  result.push(gruffaloCrumble.ingredients[9].slice(gruffaloCrumble.ingredients[9].indexOf('melted butter')));
  result.push(gruffaloCrumble.ingredients[10].slice(gruffaloCrumble.ingredients[10].indexOf('fresh water')));
  return result;
};
